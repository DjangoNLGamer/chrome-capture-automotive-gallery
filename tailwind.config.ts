	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'loading-dots': {
					'0%, 20%': { color: 'hsla(43, 74%, 49%, 0.3)' },
					'50%': { color: 'hsl(43, 74%, 49%)' },
					'100%': { color: 'hsla(43, 74%, 49%, 0.3)' }
				},
				'shimmer': {
			...
			backgroundImage: {
				...
				'gold-bg-gradient': 'linear-gradient(135deg, hsl(var(--gold-accent)) 0%, hsl(var(--gold-light)) 100%)',
			}
		}
	},
